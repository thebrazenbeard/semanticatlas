#!/usr/bin/env python3
"""Provider-neutral reference implementation of SEMANTIC_ATLAS_RUNTIME_MANIFEST_V3.
...
CONTRACT = "SEMANTIC_ATLAS_RUNTIME_MANIFEST_V3"
